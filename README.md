...
For Marketplace release, configure a standard Google Cloud project, OAuth consent and any required verification, Marketplace SDK/listing, support/privacy URLs, and submit for Google's review. No separate backend is introduced by publication. Draft listing materials, GitHub Pages website source, and current preparation status are in [marketplace/README.md](marketplace/README.md).
